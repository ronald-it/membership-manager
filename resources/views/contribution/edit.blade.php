<x-layout>
  ...
  <div class="p-4 sm:p-8 flex flex-col items-center sm:justify-center grow">
    <form method="POST" action="/contribution/{{$contribution->id}}" class="flex flex-col gap-y-4 sm:gap-y-6 text-xs sm:text-sm lg:text-lg w-full max-w-lg">
      @csrf
      @method('PUT')
      <span class="uppercase font-medium text-sm sm:text-base lg:text-3xl text-center">edit contribution</span>
      <div class="flex items-center gap-x-2">
        <label class="font-medium first-letter:uppercase w-24 lg:w-32" for="id">id</label>
      ...
      <div class="flex items-center gap-x-2">
        <label class="font-medium first-letter:uppercase w-24 lg:w-32" for="leeftijd">age</label>
      ...
      <div class="flex items-center gap-x-2">
        <label class="font-medium first-letter:uppercase w-24 lg:w-32" for="member_type">member type</label>
      ...
      <div class="flex items-center gap-x-2">
        <label class="font-medium first-letter:uppercase w-24 lg:w-32" for="fiscal_year_id">fiscal year</label>
      ...
      <div class="flex items-center gap-x-2">
        <label class="font-medium first-letter:uppercase w-24 lg:w-32" for="amount">amount</label>
