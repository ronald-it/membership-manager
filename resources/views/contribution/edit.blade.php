<x-layout>
  ...
  <div class="p-4 sm:p-8 flex flex-col items-center sm:justify-center grow">
    <form method="POST" action="/contribution/{{$contribution->id}}" class="flex flex-col gap-y-4 sm:gap-y-6 text-xs sm:text-sm lg:text-lg w-full max-w-md">
      @csrf
      @method('PUT')
      ...
      <div class="flex items-center gap-x-2">
        <label class="font-medium capitalize w-24 lg:w-28" for="leeftijd">age</label>
      ...
      <div class="flex items-center gap-x-2">
        <label class="font-medium capitalize w-24 lg:w-28" for="member_type">member type</label>
      ...
      <div class="flex items-center gap-x-2">
        <label class="font-medium capitalize w-24 lg:w-28" for="fiscal_year_id">fiscal year</label>
      ...
      <div class="flex items-center gap-x-2">
        <label class="font-medium capitalize w-24 lg:w-28" for="amount">amount</label>
